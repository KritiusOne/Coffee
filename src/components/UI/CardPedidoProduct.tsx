...
export const CardPedidoProduct: React.FC<Props> = ({cantidad,descripcion,img, nombre, price}) => {
  return (
    <article className="flex flex-col justify-center items-center shadow-[0_3px_10px_rgb(0,0,0,0.2)] font-mono max-w-96">
